...
var testCollision = function (yay1,yay2){
  var rect1 = {
...
var collisionRect= function(rect1,rect2){
...
var update_z = function(something){
  update_z_position(something);
  draw_something(something);
  };
//function to update position
var update_z_position = function (something) {
...
var gameInit = function(){ // initiate game
  running = true;
  ctx.clearRect(0,0,WIDTH,HEIGHT);
